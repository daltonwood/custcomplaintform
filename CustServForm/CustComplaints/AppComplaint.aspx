<%@ Page Title="App Complaints" Language="C#" MasterPageFile="~/Site.Master" AutoEventWireup="true" CodeBehind="AppComplaint.aspx.cs" ValidateRequest="false" Inherits="CustServForm.AppComplaint" %>
...
<%-- Location Menu --%>
   ...
   <%-- Origin of Complaint Menu --%>
    ...
    <asp:TableRow>
        <asp:TableCell>
            <asp:TextBox TextMode="MultiLine" runat="server" id="commentBox" Height="200px" Width="400px" placeholder="Additonal Info" MaxLength="500"></asp:TextBox>
        </asp:TableCell>
    </asp:TableRow>
    <asp:TableRow Height="15px"></asp:TableRow>
</asp:Table>
